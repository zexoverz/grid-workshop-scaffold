...
```
  ...
  five      with CodeBuddy   run dev    grid.dev.foruai.io
```
...
3. ✅ The agent is **registered on FORU Grid** at https://grid.dev.foruai.io — see [`docs/getting-started.md` §10](./docs/getting-started.md#10--register-your-archetype-on-foru-grid) for the screenshot-by-screenshot walkthrough
